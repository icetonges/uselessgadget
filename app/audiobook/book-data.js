/* ================= STORY DATA =================
   Single source of truth for the read-along reader AND scripts/generate-audio.mjs.
   Any edit here changes both the on-screen text and what gets narrated.
   After editing, re-run: node scripts/generate-audio.mjs (only changed paragraphs regenerate).
================================================== */
export const BOOK = [
  {
